      ...
      <div className="flex flex-col">
        ...
        <div className="flex-1 flex justify-center items-center">
          ...
          {/* <div className="mx-auto max-w-4xl px-6 lg:px-8">
            <h1 className="lg:text-8xl text-6xl font-bold tracking-tight font-sounthernAire mb-8 bg-clip-text text-transparent bg-gradient-to-r from-[#fff] to-[#1E2761] drop-shadow-lg">Work Experience</h1>
            <ul className="text-sm lg:text-lg font-nunitoLight drop-shadow">
              <li>Helklo</li>
            </ul>

            <h1 className="lg:text-8xl text-6xl font-bold tracking-tight font-sounthernAire mb-8 bg-clip-text text-transparent bg-gradient-to-r from-[#fff] to-[#1E2761] drop-shadow-lg">Education</h1>
